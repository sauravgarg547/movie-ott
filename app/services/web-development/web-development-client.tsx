...
import { getServiceSchema } from "@/app/structured-data"
import Script from "next/script"

export default function WebDevelopmentClientPage() {
  const sectionRef = useRef(null)
  const schemaData = getServiceSchema(
    "Web Development",
    "Expert web development services including React, Vue, Angular, Node.js, e-commerce solutions, PWAs, and API development.",
  )
        ...
        <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-primary/10 to-background">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Transform your digital presence with our comprehensive web development solutions. We build scalable,
              secure, and user-friendly web applications tailored to your business needs.
            </p>
          </div>
        </div>
